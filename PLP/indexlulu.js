...
//const upvNumbers = ['UPV1097838', 'UPV0308838', 'UPV0974693','UPV0902354','UPV0884072','UPV0978349','UPV0954602','UPV0852590','UPV0798413','UPV0845779','UPV0800712','UPV1056290','UPV0711936','UPV0700349','UPV0654580','UPV0657272','UPV0575386','UPV0612221','UPV0708188','UPV0555066','UPV0548275','UPV0530938','UPV0527468','UPV0955038','UPV1056536','UPV1075637','UPV0953759'];
    ...
    try {
      ...
      for (let i = 0; i < imageUrl.length; i++) {
        ...
        if (imageUrl[i].imageType === 'PRIMARY' && imageUrl[i].height === 1280) {
          const fileName = `${initialPart}_LULU_000_001.png`;
        ...
        if (imageUrl[i].imageType === 'GALLERY' && imageUrl[i].height === 1280) {
          const fileName = `${initialPart}_LULU_000_${imageCounter.toString().padStart(3, '0')}.png`;
          await downloadImage(imageUrls, downloadFolder, fileName);
          console.log(`Image ${imageCounter} downloaded successfully.`);
          imageCounter++;
          break;
